...
export class ClimatesScreen extends Component {
  ...
  render() {
    ...
    return (
      <ListScreen choices={Climates} navigate={this.navigate} flickrSearch={(name) => `${name} landscape`} />
    );
  }
}
...
export class AreasScreen extends Component {
  ...
  render() {
    ...
    return (
        <ListScreen choices={Areas} navigate={this.navigate} flickrSearch={this.flickrSearch} />
    );
  }
}
...
export class AccomodationsScreen extends Component {
  ...
  render() {
    ...
    return (
      <ListScreen choices={Accomodations} navigate={this.navigate} flickrSearch={this.flickrSearch} />
    );
  }
